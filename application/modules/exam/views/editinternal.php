...
$branch = $this->Course_model->get_all();
$edit_data = $this->Internal_exam_model->get($param2);
$sem = $this->Semester_model->semester_branch($edit_data->course_id);
$subject = $this->Subject_manager_model->subejct_list_branch_sem($edit_data->course_id,$edit_data->sem_id);
...
<div class="row">
    <div class=col-lg-12>
        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
            ...
            <?php echo form_open(base_url() . 'exam/internal_update/'.$edit_data->internal_id, array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'examform', 'target' => '_top')); ?>
            <div class="padded"> 
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="course" id="course">
                            ...
                            <option value="<?php echo $course->course_id; ?>" <?php if($course->course_id==$edit_data->course_id){ echo "selected=selected"; } ?>><?php echo $course->c_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                 <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="semester" id="semester">
                            <?php foreach ($sem as $sm): ?>
                            <option value="<?php echo $sm->s_id; ?>" <?php if($sm->s_id==$edit_data->sem_id){ echo "selected=selected"; } ?>><?php echo $sm->s_name; ?></option>
                            <?php endforeach; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="subject" id="subject">
                            ...
                            <option value="<?php echo $sub->sm_id; ?>" <?php if($sub->sm_id==$edit_data->sm_id){ echo "selected=selected"; }  ?>><?php echo $sub->subject_name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="exam_name" id="exam_name"
                               value="<?php echo $edit_data->internal_title; ?>"/>
                    </div>
                </div>               
                <div class="form-group">
