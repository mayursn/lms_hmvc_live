                    ...
                    <div class=panel-body>
                        <div class=you>
                            <ul class=list-unstyled>
                                ...
                                <li><i class="s16 icomoon-icon-arrow-right-3"></i><strong>Address:</strong> : 303, 3rd Floor, Sigma 2, Opp. Sales India, <br/><span style="margin-left: 25px;"></span>Opp Sunrise park, Vastrapur,</li>
                                ...
                                <li><i class="s16 icomoon-icon-arrow-right-3"></i><strong>Zip/Postal Code: </strong>380052</li>
